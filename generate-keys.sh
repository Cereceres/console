...
openssl req -new -sha256 -key unauthorized-client-key.pem -out unauthorized-client-csr.pem  -subj "/C=MX/ST=DF/L=Condesa/O=4yopping/OU=papi-unauthorized/CN=localhost"
